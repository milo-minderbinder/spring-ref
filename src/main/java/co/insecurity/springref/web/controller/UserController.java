...
public class UserController extends BaseController {
    ...
    public UserController(UserPersistenceService userService, PasswordEncoder passwordEncoder, UserValidator userValidator) {
        super(userService, passwordEncoder, userValidator);
    }
    ...
    public String doEditProfileConfirm(@RequestParam(required = true) String currentPassword,
        ...
        LOG.debug(String.format(
                ...
                updatedUser.toString()));
        // TODO: should prevent user from submitting different new password values to editProfile() and doEditProfileConfirm()
