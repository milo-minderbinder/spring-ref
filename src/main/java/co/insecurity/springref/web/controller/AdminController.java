...
public class AdminController extends BaseController {
    ...
    public AdminController(UserPersistenceService userService, PasswordEncoder passwordEncoder, UserValidator userValidator) {
    ...
    public String doEditUser(@ModelAttribute Alerts alerts, @ModelAttribute User user,
